...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -isystem 'extern' -I'extern/codegen/include' -DID='"MonkeMapLoader"' -DVERSION='"1.0.0"' -I'./shared' -I'./extern' -Wno-inaccessible-base -Wno-invalid-offsetof
